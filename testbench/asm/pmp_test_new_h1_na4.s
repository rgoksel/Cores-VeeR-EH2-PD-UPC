...
// Reset-isolated PMP hart1 NA4 test for VeeR-EH2.
//
// Checkpoint:
//      h1.na4_rw
...
// ---------------------------------------------------------------------------
// Hart 1 - locked NA4 R=1 W=1     (h1 cp0 = h1.na4_rw)
// ---------------------------------------------------------------------------
t_h1_na4_rw:
    dbg_char 'a'
    clear_all_pmp

    // A locked NA4 entry covers exactly the 4-byte word at guard_b_data.
    la   t0, guard_b_data
    srli t0, t0, 2
    csrw PMPADDR0, t0
...
1:  rec_pass
2:
    // The entry remains locked until reset; this binary ends after reporting.
    clear_all_pmp
    ret
...
// Report strings
msg_banner:     .asciz "\nVeeR-EH2 PMP hart1 NA4 test (verbose)\n"
