...
// Reset-isolated PMP fetch-fault test for VeeR-EH2.
//
// Checkpoint:
//      fetch_fault.X0
//
// This standalone binary exists because locked PMP state persists until reset.
// It tests only the locked X=0 instruction-fetch fault case from a clean reset.
...
// ---------------------------------------------------------------------------
// L=1 NA4 X=0 fetch fault         (cp0 = fetch_fault.X0 c=1)
// ---------------------------------------------------------------------------
...
s_h0_00: .asciz "fetch_fault.X0"

msg_banner:     .asciz "\nVeeR-EH2 PMP fetch test (verbose)\n"
