...
// Reset-isolated PMP A=OFF test for VeeR-EH2.
//
// Checkpoint:
//      aoff_disabled
//
// A=OFF must not restrict access, even when the PMP entry is locked.
...
// ---------------------------------------------------------------------------
// A=OFF disabled even when L=1     (cp0 = aoff_disabled)
// ---------------------------------------------------------------------------
t_aoff_disabled:
    dbg_char '6'
    clear_all_pmp
...
s_h0_00: .asciz "aoff_disabled"

// Report strings
msg_banner:     .asciz "\nVeeR-EH2 PMP AOFF test (verbose)\n"
