...
// Reset-isolated PMP hart1 read-deny test for VeeR-EH2.
//
// Checkpoint:
//      h1.load_deny_r0
...
// ---------------------------------------------------------------------------
// Hart 1 - locked R=0 load deny       (h1 cp0 = h1.load_deny_r0)
// ---------------------------------------------------------------------------
t_h1_read_deny:
    dbg_char 'd'
    clear_all_pmp
...
s_h1_00: .asciz "h1.load_deny_r0"

// Report strings
msg_banner:     .asciz "\nVeeR-EH2 PMP hart1 read-deny test (verbose)\n"
