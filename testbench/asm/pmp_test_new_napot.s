...
// Reset-isolated PMP NAPOT test for VeeR-EH2.
//
// Checkpoints:
//   Hart 0:
//      napot8.load
...
//   Hart 1:
//      h1.napot16.load
//      h1.napot16.store_fault
//
// This standalone binary exists because locked PMP state persists until reset.
...
_start:
    ...
    // Zero the entire result/flag region before releasing hart1.
...
// ---------------------------------------------------------------------------
// Hart 0 - L=1 NAPOT(8B) R=1 W=0
//   cp0 = napot8.load
//   cp1 = napot8.store_fault c=7
// ---------------------------------------------------------------------------
t_napot_rw_fault:
    dbg_char '5'
    clear_all_pmp
...
// ---------------------------------------------------------------------------
// Hart 1 - NAPOT(16B) R=1 W=0
//   h1 cp0 = h1.napot16.load
//   h1 cp1 = h1.napot16.store_fault c=7
// ---------------------------------------------------------------------------
t_h1_napot_16b:
    dbg_char 'b'
    clear_all_pmp
...
h1_names:
    .word s_h1_00, s_h1_01

// Checkpoint name strings
s_h0_00: .asciz "napot8.load"
s_h0_01: .asciz "napot8.store_fault"

s_h1_00: .asciz "h1.napot16.load"
s_h1_01: .asciz "h1.napot16.store_fault"

// Report strings
msg_banner:     .asciz "\nVeeR-EH2 PMP NAPOT test (verbose)\n"
